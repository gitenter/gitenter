...
- [SRS-WS-0088]{SyRS-0018,SyRS-0056,SyAD-0041} Project organizer starts a reviewing by setup the first review subsection.
- [SRS-WS-0022]{SyRS-0056,SyAD-0041,SyAD-0034} For any review subsection (not only the first one in a series), project organizer shall setup reviewing links to a particular commit (contains to-be-reviewed drafts) a non-master branch.
    - The commit is typically at the end of a particular branch.
- [SRS-WS-0089]{SyAD-0057} It is in principle possible to have multiple ongoing reviewings, even if they are in the same branch/link to the same commit. The actions (merge, ...) on the other review is treated the same as git comments not generated by this software.
- [SRS-WS-0060]{SRS-WS-0058,SRS-WS-0088} The reviewing summary page is setup when the review is setup.
...
- [SRS-WS-0090]{SRS-WS-0051} The software shall check that the commit of the new subsection is in the git downstream of the previous subsection.
...
- [SRS-WS-0053]{SRS-WS-0027} Reviewer shall be able to comment on any involved document at any time before the finalization of the entire reviewing.
    - Reviewer may comment on "Approval"/"Approval with postscripts"/"Denial" documents (but the comment itself will not be mixed with the previous ones), since document/status may still be changed.
        - *(Or should we simply rule the "Denial" document out of the reviewing activity, and treat them as the ones not in the to-be-reviewed list?)*
...
- [SRS-WS-0055]{SRS-WS-0054,SyAD-0035} The software shall (1) automatically generate/user define an overall reviewing version number and (2) merge to the master branch when the reviewing is finalized.
