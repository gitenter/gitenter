...
public class PropertiesFileParserTest {
	...
	@Ignore
	public void testReadFromGit() throws Exception {
		...
		String sha = "123";//new CommitSha(commitRecordFile, 1);
	
		PropertiesFileParser parser = new PropertiesFileParser(repositoryDirectory, sha, relativeFilepath);
		assertTrue(parser.isEnabledSystemwide());
