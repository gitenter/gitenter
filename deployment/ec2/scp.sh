...
scp -i "ec2-key-pair.pem" $HOME/immunessh/target/immunessh-0.0.2-prototype-jar-with-dependencies.jar ubuntu@ec2-52-41-66-37.us-west-2.compute.amazonaws.com:/tmp/immunessh-0.0.2-prototype-jar-with-dependencies.jar
