...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="sf" %>
    ...
    <article>
      <table class="hidden">
        <tr>
          <td class="left"><c:if test="${branchName != null}">
          <form method="GET"
            action="<s:url value="/organizations/${organization.id}/repositories/${repository.id}/branches/${branchName.name}/commits/" />">
            <input class="menu" type="submit" value="Browse Historical Commits">
          </form>
        </c:if></td>
          <td class="right"><sf:form method="GET" action="/organizations/${organization.id}/repositories/${repository.id}">
              <%-- 
